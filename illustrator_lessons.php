...
<head>
    ...
    <title>Статьи по illustrator</title>
</head>
<body>
    <div class="nav">
        <img src="image/header/illustrator_fon.png" alt="fon-h" class="fon">
            ...
            <img src="image/header/illustrator_abstraction.png" alt="abstraction" class="abstr">
    </div>
        ...
        <div class="container">
            <div class="row">
                <?php 
                    ...
                    $posts = get_articles_illustrator();
                ?>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="editor-card">
                                ...
                                <div class="logotype-description">
                                    <input type="text" name="id" id="" value="<?=$post['id']?>" style="display: none;">
                                    <h2><?=$post['title']?></h2>
                                    <div class="zagolovok"><p class="card-text"><?=$post['content']?></p></div>
                                    <!-- <form action="functions.php" method="post"><input type="submit" id="" class="btn" style="background-color: #703B94; color: #fff" value="Читать далее" name="trans"></form> -->
                                    <a href="figma_article?id=<?=$post['id']?>">Читать далее</a>
                                </div>
                            </div>
                        </div>
                    <!-- </form> -->
    ...
    <div class="footer">
        <img src="image/footer/illustrator_footer.png" alt="main footer" class="fon">
