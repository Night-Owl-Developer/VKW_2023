...
<body>
            ...
            <div class="row nav-content">
                <nav class="navbar navbar-expand-lg" style="margin-left: 5%;">
                    <div class="container-fluid" style="margin-top: -20px;">
                        <a class="navbar-brand" href="index.html"><img src="image/logotype/logotype.png" alt="логотип проекта" class="logotype"></a>
    ...
    <div class="content">
        <div class="container">
                <p>Это <span class="fpr">практические уроки</span>, которые помогут вам освоить основы работы в графическом редакторе.</p>
                <hr>
                <div class="col">
                    <div class="description">
                        <img src="image/figma/abstraction_fi.png" alt="abstraction Ph" class="l">
                            <div class="row">
                                <p>Научитесь работать с <br> <span class="f">ключевыми инструментами</span></p>
                                <div class="col">
                                    <ul>
                                        <li>шейпами</li>
                                        <li>сетками</li>
                ...
                <hr>
                <h2>Как устроено <span class="f">обучение</span></h2>
                <div class="col">
                    <div class="description">
                        <div class="row">
                            <h2><span class="i">Видео уроки</span></h2>
                            <p>Мы собрали обучающие видео, чтобы вы за короткий срок разобрались в базовых инструментах Figma и смогли ими пользоваться.</p>
                        </div>
                        <img src="image/figma/card_youtube.png" alt="видео урок" class="l">
                    </div>
                </div>
                <div class="col">
                    <div class="description">
                        <img src="image/figma/practical_Fi.png" alt="практический урок" class="l">
                        <div class="row">
                            <h2><span class="p">Практические уроки</span></h2>
                            <p>Чтобы закрепить полученные знания, вы выполните практические задания: шаг за шагом повторите действия в видеоуроке и отрисуете предоставленное задание.</p>
                        </div>
                    </div>
                </div>
                <hr>
                <div class="col">
                    <div class="description">
                        <div class="row">
                            <h2>Что нужно для <span class="fpr">обучения</span></h2>
                            <p>Чтобы пройти программу с выполнением практических заданий, вам понадобится компьютер и Figma</p>
                        </div>
                        <img src="image/figma/nout.png" alt="практический урок" class="l">
                    </div>
                </div>
        </div>
    </div>
    ...
    <div class="footer">
        <img src="image/footer/figma_footer.png" alt="main footer" class="fon-f">
