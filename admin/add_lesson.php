    ...
    <div class="container" style="margin-top: 130px; margin-left:13%;">
        <form action="" method="post">
            <div class="add-new">
                ...
                <input type="submit" name="save-l" class="save" id="save" value="Сохранить">
                <!-- <input type="submit" class="apply" id="apply" value="Опубликовать"> -->
            </div>
            <input type="text" class="inputs" name="title" id="title" placeholder="Введите заголовок урока">
            <div class="add-new">
            ...
            <div class="content-article">
                <h4>Текст статьи</h4>
                <textarea name="content-lesson" id="content-lesson" placeholder="Введите текст урока"></textarea>
