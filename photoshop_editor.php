...
<head>
    ...
    <title>О редакторе Photoshop</title>
</head>
<body>
    <div class="nav">
        ...
        <div class="container">
                ...
                <div class="col">
                    <div class="description">
                        <img src="image/photoshop/abstraction_Ph.png" alt="abstraction Ph" style="width: 700px; height: 508px;">
                            <div class="row">
                                <p>Научитесь работать с <br> <span class="p">ключевыми инструментами</span></p>
                                <div class="col">
                                    <ul>
                                        <li>шейпами</li>
                                        <li>сетками</li>
                ...
                <div class="col">
                    <div class="description">
                        ...
                        <img src="image/figma/card_youtube.png" alt="видео урок">
                    </div>
                </div>

                <div class="col">
                    <div class="description">
                        <img src="image/figma/practical_Fi.png" alt="практический урок">
                        <div class="row">
                ...
                <div class="col">
                    <div class="description">
                        ...
                        <img src="image/figma/nout.png" alt="практический урок" style="width:600px; height:500px">
                    </div>
                </div>
        </div>
    </div>
